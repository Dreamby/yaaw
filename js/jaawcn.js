  ...
  return {
    ...
    event_init: function() {
      ...
      $("#ib-file-save").live("click", function() {
        ...
        if (indexes.length == 0) {
          ARIA2.main_alert("alert-error", "至少应该选择一个文件。或者停止任务。", 5000);
        } else {
          var options = {
      ...
      if (window.FileReader) {
        ...
        $("#torrent-up-btn").addClass("disabled").tooltip({title: "文件 API 不被支持。"});
      }
      ...
      view: {
        ...
        error_msg: function() {
          var error_code_map = {
            ...
            2: "发生超时。",
            3: "找不到资源。",
            4: "找不到资源。 查看 --max-file-not-found 选项。",
            5: "找不到资源。 查看 --lowest-speed-limit 选项。",
            6: "发生网络问题。",
            7: "未完成下载。",
            8: "当需要续传来完成下载时，远端服务器不支持续传。",
            9: "没有足够磁盘空间可用。",
            10: "分片长度和来自 .aria2 控制中的不同。查看 --allow-piece-length-change 选项。",
            11: "aria2 同时下载同一文件。",
            12: "aria2 同时下载同一信息散列的种子。",
            13: "文件已存在。查看 --allow-overwrite 选项。",
            14: "重命名文件失败。查看 --auto-file-renaming 选项。",
            15: "aria2 不能打开现有文件。",
            16: "aria2 不能创建新文件或裁短现有文件。",
            17: "发生 I/O 错误。",
            18: "aria2 不能创建目录。",
            19: "名称解析失败。",
            20: "不能解析 Metalink 文档。",
            21: "FTP 命令失败。",
            22: "HTTP 响应头信息错误或非预期内容。",
            23: "发生太多的重定向。",
            24: "HTTP 授权失败。",
            25: "aria2 不能解析 bencoded 文件(通常是 .torrent 文件)。",
            26: ".torrent 文件损坏或者缺少 aria2 所需的信息。",
            27: "Magnet URI 错误。",
            28: "给出了错误/未能识别的选项或者给出了意外的选项参数。",
            29: "因为临时超载或者维护中，远端服务器不能处理请求。",
            30: "aria2 不能解析 JSON-RPC 请求。",
          };
          return function(text) {
    ...
    add_task: {
      ...
      clean: function() {
        $("#uri-input").attr("placeholder", "HTTP, FTP 或磁链");
